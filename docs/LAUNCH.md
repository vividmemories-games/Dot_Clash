...
- [x] AdMob app linked to production package
- [ ] **Staged rollout** enabled — start **5–20%**, not 100%
- [x] Pre-launch report reviewed (internal track first if needed)
...
- [x] App Review notes: test account or steps to reach Challenge (if needed)
